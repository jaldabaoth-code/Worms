...
public class ARBEWithGravityWithTiming extends ARBEWithGravity {
    ...
    public ARBEWithGravityWithTiming(double x, double y, int rectWidth, int rectHeight, IMovableHandler movableHandler) {
